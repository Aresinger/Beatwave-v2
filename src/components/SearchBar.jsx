...
setResult(await fetchDeezerApi(valueInput)) ;
  ...
  return (
    <div className='self-center-safe border-1 m-5  mt-20 md:w-lg md:h-50 rounded-2xl flex-col '>
        ...
        <button  className='border-2 rounded-2xl p-2 mr-2 bg-blue-400 text-white cursor-pointer hover:scale-125'>Cerca</button>
